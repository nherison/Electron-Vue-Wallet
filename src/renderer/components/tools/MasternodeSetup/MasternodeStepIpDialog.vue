<template>
    <el-dialog :close-on-click-modal="false" effect="fade/zoom" :visible.sync="showDialog">
        <div class="masternode-modal">
            ...
            <div class="input-field col s12">
                ...
                <span v-if="errors.has('ip')" class="form-error">{{ errors.first('ip') }}</span>
                <span
                    class="step-three-subtitle"
                >For hosting on the current system you can just google "whats my IP" and it will tell your current IP.</span>
            </div>
