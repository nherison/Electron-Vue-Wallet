<template>
    <div>
        <masternode-step-send-dialog :isVisible.sync="showStepSend" @next="onStepSendFinish"></masternode-step-send-dialog>
        ...
        <p>You can check the setup Masternode step here. Please consider you are ready for starting.</p>

        <el-row class="list-masternode">
            <ul class="collection">
                <li class="collection-item">
                    <span class="waves-effect waves-light red darken-4 btn">STEP ONE:</span>
                    <span class="command">Send 25,000 Wagerr</span>
                </li>
                <li class="collection-item">
                    <span class="waves-effect waves-light red darken-4 btn">STEP TWO:</span>
                    <span class="command">Name Masternode</span>
                </li>
                <li class="collection-item">
                    <span class="waves-effect waves-light red darken-4 btn">STEP THREE:</span>
                    <span class="command">Enter IP Address</span>
                </li>
                <li class="collection-item">
                    <span class="waves-effect waves-light red darken-4 btn">STEP FOUR:</span>
                    <span class="command">Generate Pairing Key</span>
                </li>
                <li class="collection-item">
                    <span class="waves-effect waves-light red darken-4 btn">STEP FIVE:</span>
                    <span class="command">Choose Output</span>
                </li>
                <li class="collection-item">
                    <span class="waves-effect waves-light red darken-4 btn">STEP SIX:</span>
