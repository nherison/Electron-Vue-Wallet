        ...
        <ul class="collection">
            <li class="collection-item">
                <button
                    ...
                    @click="salvageWallet"
                >Salvage Wallet</button>

                <span class="command">-salvagewallet</span>
                <span class="desc">Attempt to recover private keys from corrupt wallet.dat file.</span>
            </li>
            ...
            <li class="collection-item">
                ...
                >Rescan Blockchain Files</button>

                <span class="command">-rescan</span>
                <span class="desc">Rescan the block chain for missing transactions.</span>
            </li>
            ...
            <li class="collection-item">
                <button
                    class="waves-effect waves-light red darken-4 btn"
                    @click="recoverTxes2"
                >Recover Transactions 2</button>

                <span class="command">-zapwallettxes=2</span>
                <span class="desc">Recover transactions from block chain, drop meta-data.</span>
            </li>
            ...
            <li class="collection-item">
                ...
                <span class="desc">Rebuild block chain index from current blk000??.dat files.</span>
            </li>
            ...
            <li class="collection-item">
                ...
                >Delete Block Chain Folders</button>
